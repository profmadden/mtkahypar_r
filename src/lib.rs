...
unsafe extern "C" {
    ...
    pub fn mtkahypar_partition(nvtxs: c_uint, nhedges: c_uint, hewt: *const c_int, vtw: *const c_int, eind: *const c_ulong, eptr: *const c_ulong, part: *mut c_int, kway: c_int, passes: c_int, seed: c_ulong, imbalance: c_float);
}
